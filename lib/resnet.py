...
def resnet50(opt, pretrained_all=True, input_dim=3, **kwargs):
    model = ResNet(Bottleneck, [3, 4, 6, 3], input_dim, **kwargs)
    if pretrained_all:
        model_file = opt["weights_path"] + "/resnet50-19c8e357.pth"
